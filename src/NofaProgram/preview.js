...
class Preview extends Component {
    ...
    componentDidMount() {
        ...
        if (sss === null) {
            ...
            this.AllDataCtrl = () => {
                Services.getFilesOnly(sidValue).then(
                    response => {
                        // window.scrollTo(0, 0)
            ...
            this.downloadFileCtrl = (e, fieldname, val) => {
                ...
                Services.downloadFiles(this.state.sid, fieldname, val).then(
                    response => {
            ...
            <div className='prviewcss'>
                ...
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Pre-Screening"}>
                        <Col lg="12">
                            <p><strong>Have you undertaken a pre-application consultation for the Super NOFA program?:</strong><br /> {this.props.preAppBool1}</p>
                            {this.props.preAppBool1 === "Yes" &&
                                <p><strong>Program representative(s):</strong><br /> {this.props.preAppBool2}</p>
                            }
                            {/* <p><strong>Do you have a path for environmental approval?:</strong><br /> {this.props.preAppBool3 ? "Yes" : "No"}</p>
                            <p><strong>Is the applicant a city, county, or other local public entry, such as a public housing authority or federally recognized tribal governments within California?:</strong><br /> {this.props.preAppBool4 ? "Yes" : "No"}</p> */}
                        </Col>
                    </PanelBarItem>
                </PanelBar>
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Program Selection"}>
                        <Col lg="12">
                            ...
                            <p><strong>Program 1</strong><br /> {this.props.mhp ? "Yes" : "No"}</p>
                            <p><strong>Program 2</strong><br /> {this.props.iig ? "Yes" : "No"}</p>
                            <p><strong>Program 3</strong><br /> {this.props.vhhp ? "Yes" : "No"}</p>
                            <p><strong>Program 4</strong><br /> {this.props.fwhg ? "Yes" : "No"}</p>
                ...
                <PanelBar>
                    <PanelBarItem expanded={true} title={"Project Information"}>
                        <Col lg="12">
                            ...
                            <p><strong>Project Name: </strong> {this.props.projName}</p>
                            <p><strong>Project Description: </strong> {this.props.projDesc}</p>
                            <p><strong>Street: </strong> {this.props.projStreet}</p>
                            <p><strong>City: </strong> {this.props.projCity}</p>
                            <p><strong>County: </strong> {this.props.projCounty}</p>
                            {/* <p><strong>State: </strong> {this.props.projState}</p> */}
                            <p><strong>Zip: </strong> {this.props.projZip}</p>
                        </Col>
                    </PanelBarItem>
                </PanelBar>
                <PanelBar>
