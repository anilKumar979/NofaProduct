      ...
      <div>
        ...
        <PanelBar>
          <PanelBarItem expanded={true} title={"PROJECT DIRECTOR AND PROJECT MANAGER"}>
            ...
            <p>1. Either click on the Project Manager = Project Director button; or Enter the contact information for the Project Manager (including the confirm email); and then</p>
            <p>2. Click on the PREVIOUS OR NEXT buttons to save changes and navigate or one of the other tabs to move away from the Project Management tab without saving.</p>
