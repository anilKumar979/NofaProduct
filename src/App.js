...
function App() {
 const Home = async () => {
    window.location.href = "/faast/nofa-line-items";
};  
    return (
      <div>
        <div className="home-header" style={{ backgroundImage: `url(${`/images/istock_000018283527_full.jpg`})` }}>
                ...
                <div className="copyrights">
                  <div className="container">
                    <div className="clearfix ">
                      ...
                      <div className="copyright12">Copyright © 2022 State of California</div>
